          ...
          <div className="flex-1 flex flex-col min-w-0">
            <header className="h-14 flex items-center justify-between border-b px-4 bg-card/50 backdrop-blur-sm sticky top-0 z-10">
              ...
              <div className="flex items-center gap-2">
                {role === "admin" && (
                  <div className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-white/5 border border-white/10 text-xs font-medium select-none">
                ...
                {role === "admin" && company?.local_mode && company.local_mode !== "none" && (
                  <Button
                    size="icon"
                    variant="ghost"
                    onClick={handleSync}
